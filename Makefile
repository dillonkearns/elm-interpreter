...
CORE_SRC_OVERRIDES = build/src/elm/core/1.0.5/src/Task.elm build/src/elm/core/1.0.5/src/List.elm build/src/elm/bytes/1.0.8/src/Bytes/Decode.elm build/src/elm/bytes/1.0.8/src/Bytes/Encode.elm
