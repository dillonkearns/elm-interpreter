...
signedInt16 endianness =
  Decoder (Elm.Kernel.Bytes.read_i16 (endianness == Bytes.LE))
...
signedInt32 endianness =
  Decoder (Elm.Kernel.Bytes.read_i32 (endianness == Bytes.LE))
...
unsignedInt16 endianness =
  Decoder (Elm.Kernel.Bytes.read_u16 (endianness == Bytes.LE))
...
unsignedInt32 endianness =
  Decoder (Elm.Kernel.Bytes.read_u32 (endianness == Bytes.LE))
...
float32 endianness =
  Decoder (Elm.Kernel.Bytes.read_f32 (endianness == Bytes.LE))
...
float64 endianness =
  Decoder (Elm.Kernel.Bytes.read_f64 (endianness == Bytes.LE))
