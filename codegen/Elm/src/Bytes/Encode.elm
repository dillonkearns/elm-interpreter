...
write builder mb offset =
  case builder of
    ...
    I16 e n -> Elm.Kernel.Bytes.write_i16 mb offset n (e == Bytes.LE)
    I32 e n -> Elm.Kernel.Bytes.write_i32 mb offset n (e == Bytes.LE)
    U8    n -> Elm.Kernel.Bytes.write_u8  mb offset n
    U16 e n -> Elm.Kernel.Bytes.write_u16 mb offset n (e == Bytes.LE)
    U32 e n -> Elm.Kernel.Bytes.write_u32 mb offset n (e == Bytes.LE)
    F32 e n -> Elm.Kernel.Bytes.write_f32 mb offset n (e == Bytes.LE)
    F64 e n -> Elm.Kernel.Bytes.write_f64 mb offset n (e == Bytes.LE)
