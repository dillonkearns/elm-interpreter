            ...
            let
                ...
                ( result, callTree, logLines ) =
                    Eval.Module.traceOrEvalModule
                        { trace = tracing, coverage = False, coverageProbeLines = Set.empty, maxSteps = Nothing, tcoTarget = Nothing, callCounts = Nothing, intercepts = FastDict.empty, memoizedFunctions = MemoSpec.emptyRegistry, collectMemoStats = False, useResolvedIR = False, resolveBridge = Types.noResolveBridge }
                        moduleSource
